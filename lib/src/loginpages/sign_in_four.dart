...
class SignInFour extends StatefulWidget {
  ...
  @override
  State<SignInFour> createState() => _SignInFiveState();
}

class _SignInFiveState extends State<SignInFour> {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          child: Column(
                            children: [
                              logo(size.height / 8, size.width / 2),
                              const SizedBox(
                                height: 16,
                              ),
                              richText(23.12),
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            gradient: const LinearGradient(
              ...
              colors: [Color(0xFF3E3E42), Color(0xFF3E3E42)],
            ),
          ),
          child: SvgPicture.string(
            // Vector 5
